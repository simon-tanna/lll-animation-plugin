...
description: >
  This skill should be used when styling meshes, working with textures, creating
  custom shaders, or optimizing material performance. Covers PBR materials, Phong,
  shader materials, and material properties.
user-invocable: true
argument-hint: "[topic] e.g. PBR, phong, transparency, per-face"
---
